...
import com.cpu.scheduler.simulator.graph.ClusterQ;
...
public class RoundRobinScheduler extends Scheduler {
  ...
  public static void main(String[] args) {
    ...
    Chart chart = new Chart(li);
    System.out.println();
    System.out.println("AvgTurnAroundTime: " + chart.getAvgTurnAroundTime());
    System.out.println("AvgWaitingTime: " + chart.getAvgWaitingTime());
    System.out.println("Waiting Times for each process: ");
    chart.getWaitingTime().forEach((k, v) -> System.out.println(k.getName() + " " + v));
    System.out.println("TurnAround Times for each process: ");
    chart.getTurnAroundTime().forEach((k, v) -> System.out.println(k.getName() + " " + v));
  }
}
